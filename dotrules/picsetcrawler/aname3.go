...
/*
curl http://crazysexyasian.com/ with redirect url=base64(url)
需求： 下载静态网站中的图集
记录图库资源
...
func init() {
	config := &helper.AirConfig{
		Name:      "ANAME3",
		Domain:    "Auto crazysexyasian.com",
		HomePage:  "http://crazysexyasian.com/",
		FirstPage: "http://crazysexyasian.com/",
	}
	...
	Aname3.Name = config.Name
	Aname3.Description = config.Domain
