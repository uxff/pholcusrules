...
/*
curl http://www.alsasianporn.com/ with cdn.content.alsasianporn.com
需求： 下载静态网站中的图集
记录图库资源
...
func init() {
	config := &helper.AirConfig{
		Name:      "ANAME4",
		Domain:    "Auto alsasianporn.com",
		HomePage:  "http://www.alsasianporn.com/",
		FirstPage: "http://www.alsasianporn.com/",
	}
	...
	Aname4.Name = config.Name
	Aname4.Description = config.Domain
